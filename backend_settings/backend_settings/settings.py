...
SECRET_KEY = 'django-insecure-hz2pj^wunksmh_pbld)0v8!79f!8$*a=dkxffi31#2q$i0gmwt'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'web_scrapper',  # Database name
        'USER': 'postgres',  # Your PostgreSQL username
        'PASSWORD': 'localhost123',  # Your PostgreSQL password
